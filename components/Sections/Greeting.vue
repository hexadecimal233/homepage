...
<template>
  <!-- FIXME: Right side empty space -->
  <div
    class="flex flex-col h-dvh w-dvw items-center justify-center text-center text-white"
  >
    <img
...
.qqid::after {
  ...
  transition: 0.5s cubic-bezier(0.25, 0.85, 0.46, 0.96);
  user-select: none;
  pointer-events: none;
}
